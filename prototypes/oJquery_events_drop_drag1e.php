...
//object context management
   ...
   // deal with first time access
          ...
          $_SESSION['vObj_init'] = 0;
        	$_SESSION['vLC1'] = $_SESSION['vDC1'] . $_SESSION['vDC2'] . $_SESSION['vDC3'];  	
        	$_SESSION['vLC2'] = $_SESSION['vDC5'] ;
        	$_SESSION['vLC3'] = $_SESSION['vDC4'] ;  	
   }	
...
<form name="form3" method="POST" action="jquery_events_drop_drag1e.php">
<div id="vLC3_form">
<p>Sample Form</p>
    <p name="ddObjData" id="ddObjData"></p>
    <p>fld1
...
<!-- input name="ddEvent" id="ddEvent" type="submit" value="OK"><br / -->
    ...
    <?php echo '$_REQUEST[\'fld1\']=' . $_REQUEST['fld1'] . '<br />'; ?>
    <?php echo '$_REQUEST[\'lstbox1\']=' . $_REQUEST['lstbox1'] . '<br />'; ?>
<input name="ddEvent" id="ddEvent" type="submit" value="OK" >
</div>
</form>	
