...
<ul>
  ...
  <li><a
  href="#tab-4"><span>Remove Users</span></a> 
  <li><a
  href="#tab-5"><span>Assign Admin</span></a> 
  <li><a
  href="#tab-6"><span>Unassign Admin</span></a> 
</ul>
</div>
...
<form name="form1" id="form1" method="post" action="adm_sys_group_mgmt.php?p=form1" >
...
<form name="form2" id="form2" method="post" action="adm_sys_group_mgmt.php?p=form2" >
...
<form name="form3" id="form3" method="post" action="adm_sys_group_mgmt.php?p=form3" >
...
<form name="form4" id="form4" method="post" action="adm_sys_group_mgmt.php?p=form4" >
...
<tbody style="cursor:pointer;">
<?php if(isset($lugrid4)){echo $lugrid4;} ?>
</tbody>
</table>

<form name="form4" id="form4" method="post" action="adm_sys_group_mgmt.php?p=form4" >
<input type="hidden" name="tabmrkr4" id="tabmrkr4"  value="3" />
<br />

<table>
<tr>
<td width="125" align="right">
<input type="submit" name="submitfrm_remove_user" id="submitfrm_remove_user" value="Remove User In Group" />		
</td>
<td width="175" align="right">Selected User:&nbsp;</td>
<td width="225"><input type="text" name="tb_remove_user_lname" size="25"   /></td>
</tr>
</table>
...
<?php 
  if ($groupList) {
    echo 'Select group to remove users from:';    
    echo '  <select size="1" name="selected_group_lname"> ';
    $selected = 'selected';
    foreach ($groupList as $groupListLname) {
      $groupListLname = trim($groupListLname);
...
<tr>
<td width="125" align="right">
<input type="submit" name="submitfrm_remove_user_lookup" id="submitfrm_remove_user_lookup" 
  value="Lookup User" />		
</td>
<td width="175" align="right">Logon Name contains:&nbsp;</td>
<td width="225"><input type="text" name="tb_lname_contains4" size="25" value="<?php echo $_SESSION['tb_lname_contains4']; ?>" /></td>
</tr>
</table>	
</form>
<?php echo $tab4msg; ?>
...
<!-- TAB5 ------------------------------------------------------------------ -->
<div id="tab-5">
<h1>Assign Administrator To Group</h1>	

<form name="form5" id="form5" method="post" action="adm_sys_group_mgmt.php?p=form5" >

<table id="t5" class="example table-autosort 
                              table-autofilter 
                              table-autopage:15 
                              table-stripeclass:alternate 
                              table-page-number:t5page 
                              table-page-count:t5pages 
                              table-filtered-rowcount:t1filtercount 
                              table-rowcount:t1allcount">
<thead>
 <tr>
  <td class="table-page:previous" style="cursor:pointer;" width='225'><img src="eUI/script/images/arrow_left.gif" /></td>
  <td style="text-align:left;" width='75'>Page <span id="t5page"></span>&nbsp;of <span id="t5pages"></span></td>
  <td class="table-page:next" style="cursor:pointer;" width='150'><img src="eUI/script/images/arrow_right.gif" /></td>
 </tr>
 <tr>
  <th class="table-sortable:default" width='225'>Logon Name</th>
...
<tbody style="cursor:pointer;">
<?php if(isset($lugrid5)){echo $lugrid5;} ?>
</tbody>
</table>

<form name="form5" id="form5" method="post" action="adm_sys_group_mgmt.php?p=form5" >
<input type="hidden" name="tabmrkr5" id="tabmrkr5"  value="4" />
<br />

<table>
<tr>
<td width="125" align="right">
<input type="submit" name="submitfrm_assign_admin" id="submitfrm_assign_admin" value="Assign Administrator To Group" />		
</td>
<td width="175" align="right">Selected User:&nbsp;</td>
<td width="225"><input type="text" name="tb_assign_admin_lname" size="25"   /></td>
</tr>
</table>
...
<?php 
  if ($groupList) {
    echo 'Select group to assign administrators to:';    
    echo '  <select size="1" name="selected_group_lname"> ';
    $selected = 'selected';
    foreach ($groupList as $groupListLname) {
      $groupListLname = trim($groupListLname);
...
<tr>
<td width="125" align="right">
<input type="submit" name="submitfrm_assign_admin_lookup" id="submitfrm_assign_admin_lookup" 
  value="Lookup User" />		
</td>
<td width="175" align="right">Logon Name contains:&nbsp;</td>
<td width="225"><input type="text" name="tb_lname_contains5" size="25" value="<?php echo $_SESSION['tb_lname_contains5']; ?>" /></td>
</tr>
</table>	
</form>
<?php echo $tab5msg; ?>
...
<!-- TAB6 ------------------------------------------------------------------ -->
<div id="tab-6">
<h1>Unassign Administrator To Group</h1>	

<form name="form6" id="form6" method="post" action="adm_sys_group_mgmt.php?p=form6" >

<table id="t6" class="example table-autosort 
                              table-autofilter 
                              table-autopage:15 
                              table-stripeclass:alternate 
                              table-page-number:t6page 
                              table-page-count:t6pages 
                              table-filtered-rowcount:t1filtercount 
                              table-rowcount:t1allcount">
<thead>
 <tr>
  <td class="table-page:previous" style="cursor:pointer;" width='225'><img src="eUI/script/images/arrow_left.gif" /></td>
  <td style="text-align:left;" width='75'>Page <span id="t6page"></span>&nbsp;of <span id="t6pages"></span></td>
  <td class="table-page:next" style="cursor:pointer;" width='150'><img src="eUI/script/images/arrow_right.gif" /></td>
 </tr>
 <tr>
  <th class="table-sortable:default" width='225'>Logon Name</th>
...
<tbody style="cursor:pointer;">
<?php if(isset($lugrid6)){echo $lugrid6;} ?>
</tbody>
</table>

<form name="form6" id="form6" method="post" action="adm_sys_group_mgmt.php?p=form6" >
<input type="hidden" name="tabmrkr6" id="tabmrkr6"  value="5" />
<br />

<table>
<tr>
<td width="125" align="right">
<input type="submit" name="submitfrm_unassign_admin" id="submitfrm_unassign_admin" value="Unassign Administrator To Group" />		
</td>
<td width="175" align="right">Selected User:&nbsp;</td>
<td width="225"><input type="text" name="tb_unassign_admin_lname" size="25"   /></td>
</tr>
</table>
...
<?php 
  if ($groupList) {
    echo 'Select group to unassign administrators to:';    
    echo '  <select size="1" name="selected_group_lname"> ';
    $selected = 'selected';
    foreach ($groupList as $groupListLname) {
      $groupListLname = trim($groupListLname);
...
<tr>
<td width="125" align="right">
<input type="submit" name="submitfrm_unassign_admin_lookup" id="submitfrm_unassign_admin_lookup" 
  value="Lookup User" />		
</td>
<td width="175" align="right">Logon Name contains:&nbsp;</td>
<td width="225"><input type="text" name="tb_lname_contains6" size="25" value="<?php echo $_SESSION['tb_lname_contains6']; ?>" /></td>
</tr>
</table>	
</form>
<?php echo $tab6msg; ?>
