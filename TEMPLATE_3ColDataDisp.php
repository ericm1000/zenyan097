<?php
/* 
This is template zenyan - 3 Column Data Display Pattern.
...
//may need to relocate me based on final coding
  ...
  $_SESSION['prog'] = 'TEMPLATE_3ColDataDisp.php'; //me
...
//---------------------------------------------------------
  ...
  if ($query != "") {
    ...
    //$cxHash['1a'] = $rs['querynamegoeshere'];
  }   
...
<head>
	...
	<title>3 Column Data Display Template</title>
...
<!-- pg content here  -->
<h1>3-Col Data Display Template</h1>
<h2>Review</h2>
<table width="930" border="0" cellspacing="2" cellpadding="3">
  <tr>
    <td class="tblcollbl" width="100"><?php echo $lblHash['1a']; ?></td>
    <td class="tblcoldta" width="200"><?php echo $cxHash['1a']; ?></td>
    <td class="tblcoldiv" width="10">&nbsp;</td>
    <td class="tblcollbl" width="100"><?php echo $lblHash['1b']; ?></td>
    <td class="tblcoldta" width="200"><?php echo $cxHash['1b']; ?></td>
    <td class="tblcoldiv" width="10">&nbsp;</td>
    <td class="tblcollbl" width="100"><?php echo $lblHash['1c']; ?></td>
    <td class="tblcoldta" width="200"><?php echo $cxHash['1c']; ?></td>
    <td class="tblcoldiv" width="10">&nbsp;</td>
  </tr>
  <tr>
